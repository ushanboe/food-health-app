    ...
    return (
      <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-6 shadow-lg">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-700">Cloud Sync Unavailable</h3>
        ...
        {user ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/50 rounded-xl p-4 space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className={`font-medium flex items-center gap-1 ${
                  ...
                  lastSyncStatus === 'failed' ? 'text-red-600' :
                  lastSyncStatus === 'partial' ? 'text-yellow-600' :
                  'text-gray-600'
                }`}>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="py-2.5 px-4 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
              >
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-blue-800">Enable Cloud Sync</h3>
